...
var C = class _C {
  constructor({ strings: t3, _$litType$: i5 }, e7) {
    ...
    this.parts = [];
    let h3 = 0, d3 = 0;
    const u2 = t3.length - 1, c3 = this.parts, [v2, a3] = E(t3, i5);
    if (this.el = _C.createElement(v2, e7), A.currentNode = this.el.content, 2 === i5) {
          ...
          for (const i6 of l5.getAttributeNames())
            if (i6.endsWith("$lit$") || i6.startsWith(o3)) {
              ...
              if (t4.push(i6), void 0 !== s5) {
                ...
                c3.push({ type: 1, index: h3, name: i7[2], strings: t5, ctor: "." === i7[1] ? M : "?" === i7[1] ? k : "@" === i7[1] ? H : S2 });
              } else
...
function P(t3, i5, s5 = t3, e7) {
  var o6, n6, l5, h3;
  if (i5 === x)
    return i5;
  let r4 = void 0 !== e7 ? null === (o6 = s5._$Co) || void 0 === o6 ? void 0 : o6[e7] : s5._$Cl;
  const u2 = d2(i5) ? void 0 : i5._$litDirective$;
  return (null == r4 ? void 0 : r4.constructor) !== u2 && (null === (n6 = null == r4 ? void 0 : r4._$AO) || void 0 === n6 || n6.call(r4, false), void 0 === u2 ? r4 = void 0 : (r4 = new u2(t3), r4._$AT(t3, s5, e7)), void 0 !== e7 ? (null !== (l5 = (h3 = s5)._$Co) && void 0 !== l5 ? l5 : h3._$Co = [])[e7] = r4 : s5._$Cl = r4), void 0 !== r4 && (i5 = P(t3, r4._$AS(t3, i5.values), r4, e7)), i5;
}
var V = class {
  constructor(t3, i5) {
    this.u = [], this._$AN = void 0, this._$AD = t3, this._$AM = i5;
  }
  get parentNode() {
  ...
  v(t3) {
    ...
    for (; void 0 !== d3; ) {
      if (l5 === d3.index) {
        let i6;
        2 === d3.type ? i6 = new N(n6, n6.nextSibling, this, t3) : 1 === d3.type ? i6 = new d3.ctor(n6, d3.name, d3.strings, this, t3) : 6 === d3.type && (i6 = new I(n6, this, t3)), this.u.push(i6), d3 = e7[++r4];
      }
...
var N = class _N {
  constructor(t3, i5, s5, e7) {
    var o6;
    this.type = 2, this._$AH = b, this._$AN = void 0, this._$AA = t3, this._$AB = i5, this._$AM = s5, this.options = e7, this._$Cm = null === (o6 = null == e7 ? void 0 : e7.isConnected) || void 0 === o6 || o6;
  }
  get _$AU() {
    var t3, i5;
    return null !== (i5 = null === (t3 = this._$AM) || void 0 === t3 ? void 0 : t3._$AU) && void 0 !== i5 ? i5 : this._$Cm;
  }
  get parentNode() {
  ...
  _$AI(t3, i5 = this) {
    t3 = P(this, t3, i5), d2(t3) ? t3 === b || null == t3 || "" === t3 ? (this._$AH !== b && this._$AR(), this._$AH = b) : t3 !== this._$AH && t3 !== x && this.g(t3) : void 0 !== t3._$litType$ ? this.$(t3) : void 0 !== t3.nodeType ? this.T(t3) : c2(t3) ? this.k(t3) : this.g(t3);
  }
  O(t3, i5 = this._$AB) {
  ...
  $(t3) {
    ...
    if ((null === (i5 = this._$AH) || void 0 === i5 ? void 0 : i5._$AD) === o6)
      ...
      const t4 = new V(o6, this), i6 = t4.v(this.options);
      t4.p(s5), this.T(i6), this._$AH = t4;
    }
  }
  _$AC(t3) {
    let i5 = T.get(t3.strings);
    return void 0 === i5 && T.set(t3.strings, i5 = new C(t3)), i5;
  }
  k(t3) {
    ...
    let s5, e7 = 0;
    for (const o6 of t3)
      e7 === i5.length ? i5.push(s5 = new _N(this.O(r3()), this.O(r3()), this, this.options)) : s5 = i5[e7], s5._$AI(o6), e7++;
  ...
  setConnected(t3) {
    var i5;
    void 0 === this._$AM && (this._$Cm = t3, null === (i5 = this._$AP) || void 0 === i5 || i5.call(this, t3));
  }
};
var S2 = class {
  ...
  _$AI(t3, i5 = this, s5, e7) {
    ...
    let n6 = false;
    if (void 0 === o6)
      t3 = P(this, t3, i5, 0), n6 = !d2(t3) || t3 !== this._$AH && t3 !== x, n6 && (this._$AH = t3);
    else {
      const e8 = t3;
      let l5, h3;
      for (t3 = o6[0], l5 = 0; l5 < o6.length - 1; l5++)
        h3 = P(this, e8[s5 + l5], i5, l5), h3 === x && (h3 = this._$AH[l5]), n6 || (n6 = !d2(h3) || h3 !== this._$AH[l5]), h3 === b ? t3 = b : t3 !== b && (t3 += (null != h3 ? h3 : "") + o6[l5 + 1]), this._$AH[l5] = h3;
    }
    n6 && !e7 && this.j(t3);
  }
  j(t3) {
...
var H = class extends S2 {
  ...
  _$AI(t3, i5 = this) {
    var s5;
    if ((t3 = null !== (s5 = P(this, t3, i5, 0)) && void 0 !== s5 ? s5 : b) === x)
      return;
...
var Z = (t3, i5, s5) => {
  ...
  if (void 0 === l5) {
    ...
    n6._$litPart$ = l5 = new N(i5.insertBefore(r3(), t4), t4, void 0, null != s5 ? s5 : {});
  }
...
var s4 = class extends d {
  ...
  update(t3) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t3), this._$Do = Z(i5, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t3;
...
// assets/node_modules/@lit/reactive-element/decorators/query.js
function i4(i5, n6) {
...
function l4(n6) {
  ...
  return o5({ descriptor: (o6) => ({ get() {
    var o7;
    const r4 = "slot" + (l5 ? `[name=${l5}]` : ":not([name])"), i5 = null === (o7 = this.renderRoot) || void 0 === o7 ? void 0 : o7.querySelector(r4), s5 = null != i5 ? e6(i5, n6) : [];
...
var NotyfView = (
  ...
  function() {
    ...
    NotyfView2.prototype._popRenderedNotification = function(notification) {
      var idx = -1;
      for (var i5 = 0; i5 < this.notifications.length && idx < 0; i5++) {
        if (this.notifications[i5].notification === notification) {
          idx = i5;
        }
      }
      if (idx !== -1) {
    ...
    NotyfView2.prototype._buildNotificationCard = function(notification) {
      ...
      if (iconOpts) {
        ...
        if (typeof iconOpts === "object") {
          var _a = iconOpts.tagName, tagName = _a === void 0 ? "i" : _a, className_1 = iconOpts.className, text = iconOpts.text, _b = iconOpts.color, color2 = _b === void 0 ? mainColor : _b;
...
var lim = (v2, l5, h3) => Math.max(Math.min(v2, h3), l5);
function p2b(v2) {
...
var alpha = (a3, f2) => a3 < 255 ? f2(a3) : "";
function hexString(v2) {
  var f2 = isShort(v2) ? h1 : h22;
  return v2 ? "#" + f2(v2.r) + f2(v2.g) + f2(v2.b) + alpha(v2.a, f2) : void 0;
}
var HUE_RE = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function hsl2rgbn(h3, s5, l5) {
  const a3 = s5 * Math.min(l5, 1 - l5);
  const f2 = (n6, k2 = (n6 + h3 / 30) % 12) => l5 - a3 * Math.max(Math.min(k2 - 3, 9 - k2, 1), -1);
...
function hueValue(r4, g2, b2, d3, max2) {
  if (r4 === max2) {
    return (g2 - b2) / d3 + (g2 < b2 ? 6 : 0);
  }
  if (g2 === max2) {
    return (b2 - r4) / d3 + 2;
  }
...
function rgb2hsl(v2) {
  ...
  const g2 = v2.g / range;
  const b2 = v2.b / range;
  const max2 = Math.max(r4, g2, b2);
  const min2 = Math.min(r4, g2, b2);
  const l5 = (max2 + min2) / 2;
  let h3, s5, d3;
  if (max2 !== min2) {
    d3 = max2 - min2;
    s5 = l5 > 0.5 ? d3 / (2 - max2 - min2) : d3 / (max2 + min2);
    h3 = hueValue(r4, g2, b2, d3, max2);
    h3 = h3 * 60 + 0.5;
  }
  return [h3 | 0, s5 || 0, l5];
}
function calln(f2, a3, b2, c3) {
  return (Array.isArray(a3) ? f2(a3[0], a3[1], a3[2]) : f2(a3, b2, c3)).map(n2b);
}
function hsl2rgb(h3, s5, l5) {
  return calln(hsl2rgbn, h3, s5, l5);
}
...
function hslString(v2) {
  ...
  const s5 = n2p(a3[1]);
  const l5 = n2p(a3[2]);
  return v2.a < 255 ? `hsla(${h3}, ${s5}%, ${l5}%, ${b2n(v2.a)})` : `hsl(${h3}, ${s5}%, ${l5}%)`;
}
var map = {
  x: "dark",
  Z: "light",
...
function rgbParse(str) {
  ...
  g2 = +m2[3];
  b2 = +m2[5];
  r4 = 255 & (m2[2] ? p2b(r4) : lim(r4, 0, 255));
...
function interpolate(rgb1, rgb2, t3) {
  ...
  return {
    r: n2b(to(r4 + t3 * (from(b2n(rgb2.r)) - r4))),
...
// assets/node_modules/chart.js/dist/chunks/helpers.segment.js
function noop() {
}
var uid = /* @__PURE__ */ (() => {
  let id = 0;
...
function _angleBetween(angle, start, end, sameAngleIsFullCircle) {
  ...
  const angleToStart = _normalizeAngle(s5 - a3);
  const angleToEnd = _normalizeAngle(e7 - a3);
  const startToAngle = _normalizeAngle(a3 - s5);
  const endToAngle = _normalizeAngle(a3 - e7);
  return a3 === s5 || a3 === e7 || sameAngleIsFullCircle && s5 === e7 || angleToStart > angleToEnd && startToAngle < endToAngle;
}
...
var effects = {
  ...
  easeOutBounce(t3) {
    ...
    if (t3 < 2 / d3) {
      return m2 * (t3 -= 1.5 / d3) * t3 + 0.75;
    }
    if (t3 < 2.5 / d3) {
      return m2 * (t3 -= 2.25 / d3) * t3 + 0.9375;
    }
    return m2 * (t3 -= 2.625 / d3) * t3 + 0.984375;
  },
...
function getScope$1(node, key) {
  ...
  for (let i5 = 0, n6 = keys.length; i5 < n6; ++i5) {
    const k2 = keys[i5];
...
function _longestText(ctx, font, arrayOfThings, cache) {
  ...
  let i5, j, jlen, thing, nestedThing;
  for (i5 = 0; i5 < ilen; i5++) {
...
function _bezierInterpolation(p1, p2, t3, mode) {
  ...
  const c3 = _pointInLine(cp2, p2, t3);
  const d3 = _pointInLine(a3, b2, t3);
  const e7 = _pointInLine(b2, c3, t3);
  return _pointInLine(d3, e7, t3);
}
...
var Scale = class _Scale extends Element2 {
  ...
  _computeLabelSizes(ticks, length) {
    ...
    let i5, j, jlen, label, tickFont, fontString, cache, lineHeight, width, height, nestedLabel;
  ...
  _computeLabelItems(chartArea) {
    ...
    const items = [];
    let i5, ilen, tick, label, x2, y2, textAlign, pixel, font, lineHeight, lineCount, textOffset;
...
var Chart = class {
  ...
  _getUniformDataChanges() {
    ...
    const makeSet = (idx) => new Set(_dataChanges.filter((c3) => c3[0] === idx).map((c3, i5) => i5 + "," + c3.splice(1).join(",")));
...
function pathArc(ctx, element, offset2, spacing, end, circular) {
  ...
  if (circular) {
    ...
    if (innerEnd > 0) {
      const pCenter1 = rThetaToXY(innerEndAdjustedRadius, innerEndAdjustedAngle, x2, y2);
    ...
    if (innerStart > 0) {
      const pCenter2 = rThetaToXY(innerStartAdjustedRadius, innerStartAdjustedAngle, x2, y2);
      ctx.arc(pCenter2.x, pCenter2.y, innerStart, innerStartAdjustedAngle + Math.PI, startAngle - HALF_PI);
    }
    const p8 = rThetaToXY(outerStartAdjustedRadius, startAngle, x2, y2);
    ctx.lineTo(p8.x, p8.y);
    if (outerStart > 0) {
      const pCenter3 = rThetaToXY(outerStartAdjustedRadius, outerStartAdjustedAngle, x2, y2);
...
function minMaxDecimation(data, start, count, availableWidth) {
  let avgX = 0;
  let countX = 0;
  let i5, point, x2, y2, prevX, minIndex, maxIndex, startIndex, minY, maxY;
  const decimated = [];
  const endIndex = start + count - 1;
...
var Tooltip = class extends Element2 {
  ...
  drawBody(pt, ctx, options) {
    ...
    let bodyItem, textColor, lines, i5, j, ilen, jlen;
...
function drawPointLabels(scale, labelCount) {
  ...
  for (let i5 = labelCount - 1; i5 >= 0; i5--) {
    ...
    const { x: x2, y: y2, textAlign, left, top, right, bottom } = scale._pointLabelItems[i5];
    ...
    renderText(ctx, scale._pointLabels[i5], x2, y2 + plFont.lineHeight / 2, plFont, {
...
// assets/node_modules/chart.js/auto/auto.js
...
var PartitionMetricElement = class extends s4 {
  ...
  firstUpdated() {
    ...
    this.chart = new auto_default(this.canvasEl, {
      type: "doughnut",
      data: {
        labels: series.map((s5) => s5.label),
        datasets: [{
          data: series.map((s5) => s5.value),
          backgroundColor: series.map((s5) => resolveColor(s5.color))
        }]
      },
      options: {
        cutout: "75%",
...
__decorateClass([
  e5()
], PartitionMetricElement.prototype, "series", 2);
__decorateClass([
  i4("canvas")
], PartitionMetricElement.prototype, "canvasEl", 2);
