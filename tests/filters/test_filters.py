...
class MyFilter(BaseFilter):
    ...
    def apply(
        self, request: Request, query: DataSource
    ) -> DataSource:  # pragma: no cover
        return query
...
async def test_renders_indicator_context(
    request_f: RequestFactory, extra_template_dir: pathlib.Path
) -> None:
...
async def test_exposes_variables_into_template(
    request_f: RequestFactory, extra_template_dir: pathlib.Path
) -> None:
